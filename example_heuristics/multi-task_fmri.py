...
IntendedFor = {
    b0_phase: [
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-object_run-01_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-object_run-02_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-rhyme_run-01_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-rhyme_run-02_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-scenemem_run-01_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-scenemem_run-02_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-sentence_run-01_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-sentence_run-02_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-wordgen_run-01_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-wordgen_run-02_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-binder_run-01_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-binder_run-02_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-verbgen_run-01_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-verbgen_run-02_bold.nii.gz',
    'sub-{subject}/{session}/func/sub-{subject}_{session}_task-rest_bold.nii.gz'],
